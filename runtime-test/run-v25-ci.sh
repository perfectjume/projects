...
print('V25_OPTIONAL_EMF_CLOCK_PACKAGE_PASS')
PY
...
echo "OPTIONAL_EMF_CLOCK_MIXIN_ABSENT_TARGET_PASS" >> runtime-summary.txt
echo "IMMEDIATE_FREEZE_NO_2TICK_DELAY_PASS" >> runtime-summary.txt

python3 - <<'PY'
from pathlib import Path
import zipfile
out=Path('/tmp/hit-indicator-v25-emf-clock-freeze-evidence.zip')
paths=[
