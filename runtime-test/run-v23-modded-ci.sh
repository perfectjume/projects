...
echo "=== V23 MODDED world generation ==="
(
set -uo pipefail
cd mdk
mkdir -p run
...
echo "=== V23 MODDED literal client ==="
(
set -uo pipefail
cd mdk
mkdir -p ../screenshots
...
import zipfile
out=Path('/tmp/hit-indicator-v23-universal-stasis-grayscale-modded-evidence.zip')
paths=[
